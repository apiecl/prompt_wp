...
function cptui_register_my_cpts() {
	...
	/**
	 * Post Type: Eventos linea de tiempo.
	 */

	$labels = array(
		"name" => __( "Hitos", "twentynineteen" ),
		"singular_name" => __( "Hito", "twentynineteen" ),
	);

	$args = array(
		"label" => __( "Hitos", "twentynineteen" ),
		"labels" => $labels,
		"description" => "Hitos para la linea de tiempo",
		"public" => true,
		"publicly_queryable" => true,
		"show_ui" => true,
		"delete_with_user" => false,
		...
		"map_meta_cap" => true,
		"hierarchical" => false,
		"rewrite" => array( "slug" => "hito", "with_front" => true ),
		"query_var" => true,
		"supports" => array( "title", "editor", "thumbnail", "custom-fields" ),
	);
